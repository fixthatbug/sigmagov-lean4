...
\emph{+ 9 others} & 2,855 & 31 & Complete \\
\midrule
...
\newblock \url{https://www.anthropic.com/claude}, 2024.
...
G.~Boella, L.~van~der Torre, and H.~Verhagen.
\newblock Introduction to normative multiagent systems.
\newblock {\em Computational \& Mathematical Organization Theory},
  12:71--79, 2006.
...
\newblock In {\em CAV}, pages 3--29. Springer, 2017.
...
\newblock Reluplex: An efficient {SMT} solver for verifying deep neural
  networks.
\newblock In {\em CAV}, pages 97--117. Springer, 2017.

\bibitem{mcnamara2010}
P.~McNamara.
\newblock {\em Deontic Logic}.
\newblock The Stanford Encyclopedia of Philosophy. Stanford University, 2010.
